...
from DREAM.dataset import SingleCellDataset
from DREAM.utils import  estimate_k
from sklearn.preprocessing import MaxAbsScaler
from torch.utils.data import DataLoader
from DREAM.helpers  import clustering, measure, print_2D
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', type=str, help='input dataset path', default="../DREAM-master/data/yan.txt")
    ...
    parser.add_argument('--reference', '-r',  type=str, help='Reference celltypes',default="../DREAM-master/data/yan_label.txt")
    parser.add_argument('--transpose', '-t', action='store_true', help='Transpose the input matrix')
    DATASET = '../DREAM-master/data/yan'  # sys.argv[1]
    ...
    model = DREAM(dims, n_centroids=k)
#     print(model)
