...
class DREAM(VAE):
    def __init__(self, dims, n_centroids):
        super(DREAM, self).__init__(dims)
    ...
    def loss_function(self, x):
        ...
        likelihood, kld = elbo_DREAM(recon_x, x, gamma, (mu_c, var_c, pi), (mu, logvar), binary=self.binary)
    ...
    def init_gmm_params(self, dataloader, device='cpu'):
        """
        Init DREAM model with GMM model parameters
        """
